...
const CourseCard = ({ course }) => {
  ...
  return (
    <div className="bg-base-100 shadow-lg rounded-lg overflow-hidden hover:shadow-2xl transform hover:-translate-y-2 transition duration-300 flex flex-col">
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <p className="text-base-content/70 text-sm mb-3 flex-1">{description.slice(0,100)}...</p>
