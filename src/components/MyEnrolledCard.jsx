...
const MyEnrolledCard = ({ course, courses, setCourses }) => {
  ...
  return (
    <div className=" bg-base-100 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group border border-base-300">
          <div className="">
            <img
              src={image}
              alt={title}
          ...
          <div className="p-5 space-y-2">
            ...
            <div className="flex items-center justify-between pt-3">
              <button onClick={()=>handleDeleteEnrolled(_id)} className="btn bg-primary hover:bg-info text-white border-0 w-full">Delete</button>
            </div>
          </div>
        </div>
  );
